...
namespace MiniGym.FormularioBase
{
    public partial class FormularioBase : Form
    {
        ...
        protected void Control_Enter(object sender, EventArgs e)
        {
            ...
            {
                ((TextBox)sender).BackColor = Color.Color.ColorControlConFoco;
            }

            if (sender is NumericUpDown)
            {
                ((NumericUpDown)sender).BackColor = Color.Color.ColorControlConFoco;
            }
        }
        ...
        protected void Control_Leave(object sender, EventArgs e)
        {
            if (sender is TextBox)
            {
                ((TextBox)sender).BackColor = Color.Color.ColorControlSinFoco;
                return;
            }

            if (sender is NumericUpDown)
            {
                ((NumericUpDown)sender).BackColor = Color.Color.ColorControlSinFoco;
                return;
            }
        }
